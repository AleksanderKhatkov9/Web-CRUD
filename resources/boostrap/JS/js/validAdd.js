$(function () {
    ...
    //function on valid name and password and e-mail
    submit.addEventListener('click', function (even) {
        ...
        let patern = /^[\w-\.]+@[\w-]+\.[a-z]{2,4}$/i;
        let result = patern.test(id_email);
        if (!result) {
        ...
        $.ajax({
            method: "POST",
            // url: "../controller/UserAdd_old.php",
            url: "/dashboard/php-web/controller/UserAdd_old.php",
            data: {
                id_name: id_name,
