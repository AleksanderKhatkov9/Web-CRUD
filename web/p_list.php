...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../catalog/css/list_fons.css">
...
<div id="addEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <!--            <form method="post" action="../controller/ProductAjax.php">-->
...
<script>
    $(function () {
        ...
        $("#submit").click(function () {
            ...
            $.ajax({
                // url:"http://localhost:8080/dashboard/php-web/controller/UserAdd.php",
                // url: "http://localhost:8080/dashboard/php-web/controller/ProductAjax.php",
                url: "http://localhost:8080/dashboard/php-web/controller/ProductAjax.php",
                method: "POST",
                data: {
                    'product': product,
